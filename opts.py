...
def translate_opts(parser):
    ...
    #0427 add classification
    group.add_argument('-model_type', required=True,
                       help='Choose different model(*.pt):''e c j')
    ...
    group.add_argument('-replace_unk', action="store_true",default=True,
